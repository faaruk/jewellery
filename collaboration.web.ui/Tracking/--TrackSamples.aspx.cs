...
{
    public partial class TrackSamples : BasePage
    {
      ...
      //  static List<SamplesTracking> _lstSampleTrack = null;
        ...
        private void BindGrid()
        {
            ...
            gvTable.DataBind();
            if (Session["RequestedSampleID"] != null)
            {
                ShowViewDetailsDialog(Convert.ToInt32(Session["RequestedSampleID"]), 0);
            ...
            if (gvTable.Rows.Count > 0)
            {
                ...
                if (Session[Collaboration.Web.UI.Common.SESSION_USER]!=null)
                {
                    ...
                    if (RoleID == Convert.ToInt32(Resource.DB_AdminRoleID))
                        ...
                        gvTable.Columns[2].Visible = true;
                }
        ...
        protected void gvTable_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == Convert.ToString(Common.ActionType.ViewDetails))
            {
                ...
                ShowViewDetailsDialog(SampleID, SampleTrackID);
            }
