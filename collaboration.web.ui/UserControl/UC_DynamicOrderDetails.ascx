<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_DynamicOrderDetails.ascx.cs"
    Inherits="Collaboration.Web.UI.UserControl.UC_DynamicOrderDetails" %>
...
<%@ Register Src="~/UserControl/UC_UploadCad.ascx" TagName="UploadCAD" TagPrefix="uc2" %>
...
<script type="text/javascript">
    $(document).delegate('input#btnProfileCancel', 'click', function () {
        leaveChange();
    });
...
<asp:UpdatePanel ID="updDynamicDetails" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group" id="divStatus" runat="server">
                                ...
                                <div class="col-lg-8">
                                    <asp:DropDownList Width="40%" ID="ddlStatus" runat="server" DataTextField="Action" CssClass="form-control m-bot15"
                                        DataValueField="StatusID" onchange="leaveChange()">
                                    </asp:DropDownList>
                            ...
                            <div class="form-group" id="divUploadCAD" runat="server">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <uc2:UploadCAD ID="UploadCAD1" runat="server" />
                                ...
                                <div class="col-lg-8">
                                    <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="IsCustomerInstruction" HeaderStyle-ForeColor="#797979" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIsCustomerInstruction" runat="server" Text='<%# Bind("IsUpdatedByCustomer") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Customer Instructions" HeaderStyle-ForeColor="#797979">
                                                <ItemTemplate>
                                                    <div id="divChangeInstructionsCustomer" style="width: 100%; overflow-y: auto; overflow-x: auto; word-break: break-all;" runat="server">
                                                        <asp:Label ID="lblChangeInstructionsCustomer" runat="server" Text='<%# Bind("ChangeInstructionsCustomer") %>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
        ...
        <asp:Panel ID="pnlCompareCAD" runat="server" Style="display: none">
            <div class="modal-dialog" style="width: 1400px; height: 600px; padding-top: 0px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <button id="btnCancelCADCompare" type="button" class="close" data-dismiss="modal" aria-hidden="true"
                            onclick="$('#btnProfileCancel').click(); leaveChange();">
                            &times;</button>
                        <%--runat="server" --%>
                        <%--onserverclick="btnCancelCADCompare_Click"--%>
                        <%--onclick="$('#btnProfileCancel').click()"--%>
                        <h4 class="modal-title">Compare CAD</h4>
                    </div>
