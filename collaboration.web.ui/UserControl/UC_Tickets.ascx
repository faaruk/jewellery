<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_Tickets.ascx.cs"
    Inherits="Collaboration.Web.UI.UserControl.UC_Tickets" %>
...
<div>
    ...
    <div style="height: 500px;">
        <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="panel-body bio-graph-info form-horizontal cmxform tasi-form" style="height: 500px;
                    overflow-y: auto; padding: top:0px;">
                    <asp:ListView ID="gvTable" runat="server" ShowHeader="false" AutoGenerateColumns="False"
                        DataKeyNames="TicketID" AllowSorting="false" OnItemDataBound="gvTable_RowDataBound">
                        <%--                        <Columns>
                            <asp:TemplateField>--%>
                        <ItemTemplate>
                                        ...
                                        <div class="msg-time-chat">
                                            <div class="msg-in" style="margin-left: 5px;">
                                                <div class="text" style="border: 0px">
                                                    <p>
                                                        <asp:Label Visible="true" runat="server" ID="lblTicketText" Text='<%# Eval("TicketText")%>'></asp:Label>
                                                    </p>
                        ...
                        <div class="chat-form" style="margin-top: 100px; padding-left: 15px; padding-right: 15px">
                            <div class="input-cont" style="margin-top: 18px;">
                                ...
                                <asp:RequiredFieldValidator Display="Dynamic" SetFocusOnError="true" ID="RequiredFieldValidator1"
                                    ...
                                    ForeColor="Red" ErrorMessage="Ticket Text is required." InitialValue="" ValidationGroup="AddMessageValidationGroup"></asp:RequiredFieldValidator>
                            </div>
                            <div class="pull-left" style="margin-top: 18px; padding-left: 0px">
                                <a href="javascript:;">Assign Ticket To</a>
                                ...
                                OnUploadComplete="File_Upload" OnClientUploadComplete="uploadComplete" MaximumNumberOfFiles="1"  />
