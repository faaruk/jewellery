<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_Header.ascx.cs" Inherits="Collaboration.Web.UI.UserControl.UC_Header" %>

<%@ Import Namespace="System.Configuration" %>
<asp:Timer runat='server' ID='timer1' Enabled='true' Interval='6000'></asp:Timer>s
