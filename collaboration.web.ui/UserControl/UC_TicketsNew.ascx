<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_TicketsNew.ascx.cs"
    Inherits="Collaboration.Web.UI.UserControl.UC_TicketsNew" %>
                    ...
                    <div class="row" style="margin-left: 5px; margin-right: 5px; margin-bottom: 5px;">
                        <div class="chat-form" style="margin-top: 100px; padding-left: 15px; padding-right: 15px">
                            ...
                            <div class="pull-left" style="margin-top: 18px; padding-left: 0px">
                                ...
                                <ajax:AjaxFileUpload ID="specimenFileUpload2" runat="server"
                                    OnUploadComplete="File_Uploadx" OnClientUploadComplete="uploadComplete" MaximumNumberOfFiles="1" />
