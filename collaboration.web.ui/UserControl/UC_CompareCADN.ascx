<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_CompareCADN.ascx.cs"
    Inherits="Collaboration.Web.UI.UserControl.UC_CompareCADN" %>
...
<div style="width: 1350px;">
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel-body bio-graph-info form-horizontal cmxform tasi-form" style="height: auto; overflow-y: auto; padding: 0px; top: 0px;">
                <asp:ListView ID="gvTable" runat="server" ShowHeader="false" AutoGenerateColumns="False"
                    ...
                    <ItemTemplate>
                        <div class="row" style="background: #f1f2f7; margin-left: 5px; margin-right: 5px">
                            <div style="padding: 0px 15px 0px 15px">
                                <div class="panel" style="background: #f1f2f7; vertical-align: central;">
                                    <div style="text-align: center">
                                        <h6>
                                            <b>
                                                <asp:Image ID="imgCAD" Style='width: auto; height: auto; max-height: 100%; max-width: 100%;' runat="server" ImageUrl='<%# Eval("CADLocationURL") %>' />
                                            </b>
                                        </h6>
                    ...
                    <AlternatingItemTemplate>
                        <div class="row" style="background: ; margin-left: 5px; margin-right: 5px;">
                            <div style="padding: 0px 15px 0px 15px;">
                                <div class="panel" style="vertical-align: central;">
                                    <div style="text-align: center">
                                        <h6>
                                            <b>
                                                <asp:Image ID="imgCAD" Style='width: auto; height: auto; max-height: 100%; max-width: 100%;' runat="server" ImageUrl='<%# Eval("CADLocationURL") %>' />
                ...
                <asp:DataList Visible="false" ID="dlimgCADIns" runat="server" RepeatColumns="1" RepeatDirection="Horizontal"
                    BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" OnItemDataBound="dlimgCADIns_RowDataBound"
                    CellPadding="3" ItemStyle-HorizontalAlign="Center" HorizontalAlign="Center">
                    <ItemTemplate>
                        <div class="row" style="background: ; margin-left: 5px; margin-right: 5px;">
                            <div style="padding: 0px 15px 0px 15px;">
                                <div class="panel" style="vertical-align: central;">
                                    <div style="text-align: center">
                                        <h6>
                                            <b>
                                                Image Instruction:
                                                <br />
                                                <asp:Image ID="imgCADIns" Style='width: auto; height: auto; max-height: 100%; max-width: 100%;' runat="server" />
                                            </b>
                                        </h6>
                                        <%--</asp:HyperLink>--%>
                                    </div>
