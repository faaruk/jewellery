...
{
    public partial class UC_EditProfileN : System.Web.UI.UserControl
    {
        User _userInfo = null;
        ...
        static int _userIDx = 0;
        public int UserIDx { set { _userIDx = value; } get { return (Session[Collaboration.Web.UI.Common.SESSION_USER] as User).UserID; } }
        ...
        bool IsUsernameUniq()
        {
            ...
            _userInfo = _accountManager.GetUserInfo(UserIDx);
            IEnumerable<User> UserList = _accountManager.GetUsers();
            //_userInfo = (Session[Collaboration.Web.UI.Common.SESSION_USERSLIST] as List<User>).Where(x => x.UserID == UserIDx).First();
            //var UserList = (Session[Collaboration.Web.UI.Common.SESSION_USERSLIST] as List<User>);
