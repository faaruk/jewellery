...
namespace Collaboration.Web.UI
{
    ...
    public partial class Global : System.Web.HttpApplication
    {
        ...
        //    //logger.LogError(sb.ToString() +exception);
        //    ExceptionUtility.LogException(exception, Common.INFO_SENDER + Request.RawUrl);
        //    Server.ClearError();
        //    Application["ErrorText"] = exception.ToString();
