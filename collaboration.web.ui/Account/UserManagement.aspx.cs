...
{
    public partial class UserManagementN : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            EditProfile1.ParentPopup = mpShowUpdate;
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            EditProfile1.ActionType = Convert.ToString(Common.ActionType.Add);
            EditProfile1.btnHandler += new UserControl.UC_EditProfileN.OnButtonClick(Edit_btnHandler);
            ShowAddDialog();
        }
        /// <summary>
        ...
        protected void gvTable_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == Convert.ToString(Common.ActionType.Edit))
            {
                ...
                EditProfile1.UserID = Convert.ToInt32(e.CommandArgument);
                EditProfile1.ActionType = Convert.ToString(Common.ActionType.Edit);
                ShowAddDialog();
            }
