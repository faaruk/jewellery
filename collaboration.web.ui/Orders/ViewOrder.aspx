<%@ Page Title="" Language="C#" MasterPageFile="~/DasbhoardMaster.master" AutoEventWireup="true" CodeFile="ViewOrder.aspx.cs" Inherits="Collaboration.Web.UI.Orders.ViewOrder" Theme="Office2010Silver" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div class="panel">
        ...
        <div class="panel-body">
            ...
            <dx:ASPxGridView ID="gvTable" runat="server" AutoGenerateColumns="False" KeyFieldName="OrderID" Width="100%">
                <Columns>
            ...
            <asp:ObjectDataSource ID="OrdersDataSource" runat="server" TypeName="Collaboration.Business.Components.OrderManager" SelectMethod="GetOrders">
                <SelectParameters>
