<%@ Page Title="" Language="C#" MasterPageFile="~/DasbhoardMaster.Master"
    AutoEventWireup="true" CodeFile="Tickets.aspx.cs" Inherits="Collaboration.Web.UI.Tickets.TicketsNew" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <script type="text/javascript">
        ...
        function ShowConfirmation() {
            ...
            if (Selected == false) {
                ...
                var txt;
                var r = confirm("Are you sure to Close the selected " + intcount + " ticket(s).");
                if (r == true) {
                    //alert("1");
                    return true;
                }
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div id="divConfirmation" runat="server" style="display: none" class="alert alert-block alert-danger fade in">
                <button data-dismiss="alert" class="close close-sm" type="button">
                    <i class="icon-remove"></i>
                </button>
                <asp:Literal ID="ltConfirmation" runat="server"></asp:Literal>
            </div>
          <div class="space15">
            </div>
            <div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button runat="server" id="imgCancel" type="button" class="close" data-dismiss="modal"
                                            ...
                                            &times;</button>
                                        <h4 class="modal-title">Create New Ticket
                                        </h4>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <ajax:AjaxFileUpload ID="specimenFileUpload1" runat="server"
                                                    ...
                                                    OnUploadComplete="File_Upload1" 
                                                    OnClientUploadComplete="uploadCompleteNew" 
                                                    MaximumNumberOfFiles="1" OnClientUploadError="uploadErrorNew" />
                                                
                                                <div>
                                                    Please be informed that only the latest image file will be uploaded.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer" style="border-top: 1px solid #e5e5e5; padding: 19px 20px 20px; text-align: right;">
                                        <div class="form-group">
                                            <div>
                                                <asp:Button runat="server" Text="Submit" CssClass="btn btn-primary" ID="btnSubmit" OnClick="btnSubmitTicket_Click" ValidationGroup="CreateTicketValidationGroup"></asp:Button>
                                                <asp:Button data-dismiss="modal" runat="server" ID="btnCancel" Text="Close" CssClass="btn btn-default"></asp:Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="adv-table editable-table ">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-ForeColor="#797979">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:TextBox runat="server" ID="txtKeyField" Text='<%#Eval("TicketThreadID") %>' Style="display: none" />
                                    </ItemTemplate>
                ...
                <div class="form-group pull-left" style="margin-top: 0px; padding-right: 10px">
                    <div class="pull-left">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-danger btn-xs"
                                     Text="Close Selected Tickets" OnClientClick="return ShowConfirmation();" OnClick="btnSend_Click" />
