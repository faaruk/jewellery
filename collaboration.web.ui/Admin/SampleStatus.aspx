<%@ Page Title="" Language="C#" MasterPageFile="~/DasbhoardMaster.Master" AutoEventWireup="true" CodeBehind="SampleStatus.aspx.cs" Inherits="Collaboration.Web.UI.Admin.SampleStatus" %>
        ...
        <div class="panel-body">
            <div class="adv-table editable-table ">
                                                ...
                                                <div class="panel-body bio-graph-info form-horizontal">
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">
                                                            Status Name</label>
                                                        <div class="col-lg-6">
                                                            <asp:TextBox ID="txtStatusName" runat="server" CssClass="form-control" MaxLength="50" AutoPostBack="true" OnTextChanged="txtStatusName_TextChanged"></asp:TextBox>
                                                            <asp:RequiredFieldValidator Display="Dynamic" SetFocusOnError="true" ID="txtStatusNameRequired"
                                                                runat="server" ControlToValidate="txtStatusName" CssClass="failureNotification"
                                                                ForeColor="Red" ErrorMessage="Status Name is required." InitialValue="" ValidationGroup="EditSampleStatusValidationGroup"></asp:RequiredFieldValidator>
                                                            <asp:CustomValidator ID="StatusUniqValidator" runat="server" ForeColor="Red" Display="Dynamic" Text="This status already exists"></asp:CustomValidator>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">
                                                            Description</label>
                                                        <div class="col-lg-6">
                                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control" MaxLength="500" TextMode="MultiLine" Columns="10" Rows="3" ></asp:TextBox>
                ...
                <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="False" DataKeyNames="SampleStatusID"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Status Name" HeaderStyle-ForeColor="#797979">
                                    <ItemTemplate>
                                        <asp:Label ID="lblStatusName" runat="server" Text='<%# Bind("SampleStatusName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="Edit" ToolTip="Edit"
                                            CommandArgument='<%# Eval("SampleStatusID") %>'></asp:LinkButton>
                                        &nbsp; | &nbsp;
                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Text="Delete"
                                            CommandArgument='<%# Eval("SampleStatusID") %>' OnClick="btnDelete_Click"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
