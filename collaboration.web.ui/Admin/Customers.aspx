<%@ Page Title="" Language="C#" MasterPageFile="~/DasbhoardMaster.Master" AutoEventWireup="true" 
    CodeFile="Customers.aspx.cs" Inherits="Collaboration.Web.UI.Admin.Admin_Default" Theme="Office2010Silver"%>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <asp:Button runat="server" Text="Import" CssClass="btn btn-info" ID="btnImport" OnClick="btnImport_Click" ValidationGroup="vg"></asp:Button>
                    </div>
                </div>
            </div>
            <!-- page end-->
