<%@ Page Title="Process Type" Language="C#" AutoEventWireup="true" CodeBehind="ProcessTypes.aspx.cs"
    MasterPageFile="~/DasbhoardMaster.Master" Inherits="Collaboration.Web.UI.Admin.ProcessTypes" %>
        ...
        <div class="panel-body">
            <div class="adv-table editable-table ">
                        ...
                        <asp:UpdatePanel ID="updAdd" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <ajaxToolkit:ModalPopupExtender BehaviorID="ModalBehaviour" ID="mpAdd" BackgroundCssClass="modalBackground" runat="server"
                                    TargetControlID="ldlDummy" PopupControlID="pnl" Y="100" CancelControlID="btnCancelProcessType">
                                                ...
                                                <div class="panel-body bio-graph-info form-horizontal">
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">
                                                            Process Type</label>
                                                        <div class="col-lg-6">
                                                            <asp:TextBox ID="txtType" runat="server" CssClass="form-control" MaxLength="50" AutoPostBack="true" OnTextChanged="txtType_TextChanged"></asp:TextBox>
                                                            <asp:RequiredFieldValidator Display="Dynamic" SetFocusOnError="true" ID="txtTypeRequired"
                                                                runat="server" ControlToValidate="txtType" CssClass="failureNotification" ForeColor="Red"
                                                                ErrorMessage="Process Type is required." InitialValue="" ValidationGroup="EditProcessTypeValidationGroup"></asp:RequiredFieldValidator>
                                                            <asp:CustomValidator ID="TypeUniqValidator" runat="server" ForeColor="Red" Display="Dynamic" Text="This type is already exists"></asp:CustomValidator>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-offset-4 col-lg-10">
                                                            <asp:Button runat="server" Text="Save" CssClass="btn btn-primary" ID="btnUpdate"
                                                                OnClick="btnUpdate_Click" ValidationGroup="EditProcessTypeValidationGroup"></asp:Button>
                                                            <asp:Button data-dismiss="modal" runat="server" ID="btnCancelProcessType" Text="Close"
                ...
                <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="False" DataKeyNames="ProcessTypeID"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Process Type" HeaderStyle-ForeColor="Black">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProcessTypeType" runat="server" Text='<%# Bind("Type") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Description" HeaderStyle-ForeColor="Black">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFrequency" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="Edit" ToolTip="Edit"
                                            CommandArgument='<%# Eval("ProcessTypeID") %>'></asp:LinkButton>
                                             &nbsp; | &nbsp;
                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Text="Delete"
                                            CommandArgument='<%# Eval("ProcessTypeID") %>' OnClick="btnDelete_Click"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
