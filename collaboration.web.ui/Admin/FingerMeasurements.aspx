<%@ Page Title="Finger Size Management" Language="C#" AutoEventWireup="true" CodeBehind="FingerMeasurements.aspx.cs"
    MasterPageFile="~/DasbhoardMaster.Master" Inherits="Collaboration.Web.UI.Admin.FingerMeasurements" %>
        ...
        <div class="panel-body">
            <div class="adv-table editable-table ">
                        ...
                        <asp:UpdatePanel ID="updAdd" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <ajaxToolkit:ModalPopupExtender BehaviorID="ModalBehaviour" ID="mpAdd" BackgroundCssClass="modalBackground" runat="server"
                                    TargetControlID="ldlDummy" PopupControlID="pnl" Y="100" CancelControlID="btnCancelFingerSize">
                                                ...
                                                <div class="panel-body bio-graph-info form-horizontal">
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">
                                                            Finger Size</label>
                                                        <div class="col-lg-6">
                                                            <asp:TextBox ID="txtFingerSize" runat="server" CssClass="form-control" MaxLength="50" AutoPostBack="true" OnTextChanged="txtFingerSize_TextChanged"></asp:TextBox>
                                                            <asp:RequiredFieldValidator Display="Dynamic" SetFocusOnError="true" ID="txtFingerSizeRequired"
                                                                runat="server" ControlToValidate="txtFingerSize" CssClass="failureNotification"
                                                                ForeColor="Red" ErrorMessage="Finger size is required." InitialValue="" ValidationGroup="EditFingerSizeValidationGroup"></asp:RequiredFieldValidator>
                                                            <asp:CustomValidator ID="UniqFingerSizeValidator" runat="server" ForeColor="Red" Text="This size is already exists" Display="Dynamic"></asp:CustomValidator>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-offset-4 col-lg-10">
                                                            <asp:Button runat="server" Text="Save" CssClass="btn btn-default" ID="btnUpdate"
                                                                OnClick="btnUpdate_Click" ValidationGroup="EditFingerSizeValidationGroup"></asp:Button>
                                                            <asp:Button data-dismiss="modal" runat="server" ID="btnCancelFingerSize" Text="Close"
                ...
                <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="False" DataKeyNames="FingerSizeID"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Finger Size" HeaderStyle-ForeColor="#797979">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFingerSize" runat="server" Text='<%# Bind("Size") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="Edit" ToolTip="Edit"
                                            CommandArgument='<%# Eval("FingerSizeID") %>'></asp:LinkButton>
                                        &nbsp; | &nbsp;
                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Text="Delete"
                                            CommandArgument='<%# Eval("FingerSizeID") %>' OnClick="btnDelete_Click"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
