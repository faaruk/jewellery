<%@ Page Title="Ring Type Management" Language="C#" AutoEventWireup="true" CodeBehind="RingTypes.aspx.cs"
    MasterPageFile="~/DasbhoardMaster.Master" Inherits="Collaboration.Web.UI.Admin.RingTypes" %>
        ...
        <div class="panel-body">
            <div class="adv-table editable-table ">
                        ...
                        <asp:UpdatePanel ID="updAdd" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <ajaxToolkit:ModalPopupExtender BehaviorID="ModalBehaviour" ID="mpAdd" BackgroundCssClass="modalBackground" runat="server"
                                    TargetControlID="ldlDummy" PopupControlID="pnl" Y="100" CancelControlID="btnCancelRingType">
                                                ...
                                                <div class="panel-body bio-graph-info form-horizontal">
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">
                                                            Ring Type</label>
                                                        <div class="col-lg-6">
                                                            <asp:TextBox ID="txtRingType" runat="server" CssClass="form-control" MaxLength="50" AutoPostBack="true" OnTextChanged="txtRingType_TextChanged"></asp:TextBox>
                                                            <asp:RequiredFieldValidator Display="Dynamic" SetFocusOnError="true" ID="txtRingTypeRequired"
                                                                runat="server" ControlToValidate="txtRingType" CssClass="failureNotification"
                                                                ForeColor="Red" ErrorMessage="Ring Type is required." InitialValue="" ValidationGroup="EditRingTypeValidationGroup"></asp:RequiredFieldValidator>
                                                            <asp:CustomValidator ID="RingTypeUniqValidator" runat="server" ForeColor="Red" Display="Dynamic" Text="This ring type already exists"></asp:CustomValidator>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-offset-4 col-lg-10">
                                                            <asp:Button runat="server" Text="Save" CssClass="btn btn-primary" ID="btnUpdate"
                                                                OnClick="btnUpdate_Click" ValidationGroup="EditRingTypeValidationGroup"></asp:Button>
                                                            <asp:Button data-dismiss="modal" runat="server" ID="btnCancelRingType" Text="Close"
                ...
                <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvTable" runat="server" AutoGenerateColumns="False" DataKeyNames="RingTypeID"
                            ...
                            OnRowEditing="gvTable_RowEditing" CssClass="table table-striped table-hover table-bordered dataTable myTable" OnPreRender="gvTable_PreRender">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:TemplateField HeaderText="Ring Type" HeaderStyle-ForeColor="#797979">
                                    <ItemTemplate>
                                        <asp:Label ID="lblRingType" runat="server" Text='<%# Bind("Type") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="Edit" ToolTip="Edit"
                                            CommandArgument='<%# Eval("RingTypeID") %>'></asp:LinkButton>
                                        &nbsp; | &nbsp;
                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Text="Delete"
                                            CommandArgument='<%# Eval("RingTypeID") %>' OnClick="btnDelete_Click"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
